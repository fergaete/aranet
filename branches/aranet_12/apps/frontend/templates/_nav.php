...
[
    ...
    [null,'<?php echo __('Companies') ?>',null,null,null,
        [null,'<?php echo __('Clients') ?>',null,null,null,
            ['<?php echo image_tag('icons/list.png');?>', '<?php echo __('View all clients') ?>','<?php echo url_for('@client_list');?>','_self',null],
        ...
        [null,'<?php echo __('Vendors') ?>',null,null,null,
            ['<?php echo image_tag('icons/list.png');?>', '<?php echo __('View all vendors') ?>','<?php echo url_for('@vendor_list');?>','_self',null],
