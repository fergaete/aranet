...
class budgetActions extends anActions
{
   ...
   * @author Pablo Sánchez <pablo.sanchez@aranova.es>
   **/
  public function executeGetTypesOfHour(sfWebRequest $request) {
  ...
  public function executeCreate(sfWebRequest $request)
  {
    ...
    if (!$this->getUser()->getFlash('budget')) {
      $this->budget = $this->getBudget();
    } else {
      $this->budget = $this->getUser()->getFlash('budget');
    }
    if ($this->hasRequestParameter('id')) {
      // Copy object
  ...
  public function executeUpdate()
  {
    ...
    if ($request->getParameter('budget_client_id', -1) == -1) {
    ...
    if ($request->getParameter('budget_project_id', -1) == -1) {
  ...
  public function executeAutocomplete()
  {
    ...
    $budget_name = $request->getParameter('filters[budget_name]');
    if (!$budget_name) {
