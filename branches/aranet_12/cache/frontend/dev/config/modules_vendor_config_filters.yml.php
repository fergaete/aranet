...
list($class, $parameters) = (array) sfConfig::get('sf_myCultureFilter_filter', array('myCultureFilter', null));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);

list($class, $parameters) = (array) sfConfig::get('sf_security_filter_filter', array('sfGuardBasicSecurityFilter', null));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);
