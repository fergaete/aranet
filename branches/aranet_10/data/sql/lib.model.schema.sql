...
(
	...
	`timesheet_hours` FLOAT default 0.0,
...
(
	...
	`type_of_hour_cost` FLOAT default 0.0,
	PRIMARY KEY (`id`),
...
(
	...
	`milestone_estimated_hours` DOUBLE default 0.0,
	`milestone_total_hours` DOUBLE default 0.0,
	`milestone_total_hour_costs` DOUBLE default 0.0,
	`created_at` DATETIME,
	`created_by` INTEGER default null,
	`updated_at` DATETIME,
	`updated_by` INTEGER default null,
...
(
	...
	`task_total_duration` FLOAT default 0.0,
	`task_priority_id` INTEGER,
	`task_project_id` INTEGER,
	`task_milestone_id` INTEGER default null,
	`task_budget_id` INTEGER default null,
	`task_estimated_hours` DOUBLE default 0.0,
	`task_total_hours` DOUBLE default 0.0,
	`task_total_hour_costs` DOUBLE default 0.0,
	`created_at` DATETIME,
	`created_by` INTEGER default null,
	`updated_at` DATETIME,
	`updated_by` INTEGER default null,
...
(
	...
	`invoice_tax_rate` FLOAT default 0.0,
	`invoice_freight_charge` FLOAT default 0.0,
	...
	`invoice_late_fee_percent` FLOAT default 0.0,
	`invoice_total_amount` DOUBLE default 0.0,
	`created_at` DATETIME,
	`created_by` INTEGER default null,
	`updated_at` DATETIME,
	`updated_by` INTEGER default null,
...
(
	...
	`item_quantity` FLOAT default 0.0,
	`item_cost` DOUBLE default 0.0,
	`item_tax_rate` FLOAT default 0.0,
...
(
	...
	`budget_tax_rate` FLOAT default 0.0,
	`budget_freight_charge` FLOAT default 0.0,
	`budget_total_cost` FLOAT default 0.0,
	`budget_total_amount` FLOAT default 0.0,
...
(
	...
	`item_cost` DOUBLE default 0.0,
	`item_margin` DOUBLE default 0.0,
	`item_retail_price` DOUBLE default 0.0,
	`item_tax_rate` FLOAT default 0.0,
...
(
	...
	`expense_item_amount` DOUBLE default 0.0 NOT NULL,
	`expense_item_base` DOUBLE default 0.0,
	`expense_item_tax_rate` FLOAT default 0.0,
	`expense_item_irpf` DOUBLE default 0.0,
	`expense_item_invoice_number:varchar(128) expense_item_vendor_id` INTEGER default null,
	...
	CONSTRAINT `aranet_expense_item_FK_2`
		...
		REFERENCES `aranet_project` (`id`)
		ON DELETE CASCADE,
	INDEX `aranet_expense_item_FI_3` (`expense_item_invoice_number:varchar(128) expense_item_vendor_id`),
	CONSTRAINT `aranet_expense_item_FK_3`
		FOREIGN KEY (`expense_item_invoice_number:varchar(128) expense_item_vendor_id`)
...
(
	...
	`income_item_amount` DOUBLE default 0.0 NOT NULL,
	`income_item_base` DOUBLE default 0.0,
	`income_item_tax_rate` FLOAT default 0.0,
	`income_item_irpf` DOUBLE default 0.0,
...
(
	...
	`cash_item_amount` DOUBLE default 0.0 NOT NULL,
	`created_at` DATETIME,
	`created_by` INTEGER default null,
	`updated_at` DATETIME,
	`updated_by` INTEGER default null,
