...
<fo:table-cell padding="0.2cm" padding-top="0.5cm">
    ...
    <fo:block font-size="12pt"
                ...
                line-height="20pt"
                text-align="start">
            Núm.: <fo:inline font-family="DejaVuSans-Bold"><?php echo $budget->getFullNumber() ?></fo:inline>
    </fo:block>
    <fo:block font-size="12pt"
                font-family="DejaVuSans"
                line-height="20pt"
                text-align="start">
            Revisión: <fo:inline font-family="DejaVuSans-Bold"><?php echo $budget->getBudgetRevision() ?></fo:inline>
    </fo:block>
    </fo:table-cell>
    ...
    <?php if ($budget->getDefaultContact()) : ?>
    <fo:block font-size="12pt"
                font-family="DejaVuSans"
                line-height="24pt"
                text-align="center">
            A/A.: <?php echo $budget->getDefaultContact() ?>
    </fo:block>
    <?php endif ?>
<?php
$address = $budget->getClient()->getDefaultAddress();
if (!$address) {
  $address = $budget->getDefaultContact()->getDefaultAddress();
    if (!$address) {
      $address = $budget->getDefaultContact()->getAddresses();
    }
} ?>
