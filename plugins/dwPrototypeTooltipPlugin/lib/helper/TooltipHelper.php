 ...
 * @version    SVN: $Id: TooltipHelper.php 3 2008-08-06 07:48:19Z pablo $
 */

  $sf_prototype_web_dir = sfConfig::get('sf_prototype_web_dir', '/sf/prototype');

  $request = sfContext::getInstance()->getResponse();
  $request->addJavascript($sf_prototype_web_dir.'/js/prototype');
  $request->addJavascript($sf_prototype_web_dir.'/js/scriptaculous');
