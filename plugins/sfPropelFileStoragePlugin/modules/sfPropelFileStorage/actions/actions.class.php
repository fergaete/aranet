...
class sfPropelFileStorageActions extends sfActions
{
  ...
  {
    $this->file_info = sfPropelFileStorageInfoPeer::retrieveByPk($this->getRequestParameter('file_id'));
  ...
  {
    $file_info = sfPropelFileStorageInfoPeer::retrieveByPk($this->getRequestParameter('file_id'));    
  ...
  {
    $file_info = sfPropelFileStorageInfoPeer::retrieveByName(urldecode($this->getRequestParameter('name')));
    $this->forward404Unless($file_info);
