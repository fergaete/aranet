 ...
 * @version    SVN: $Id: arPropelAddressableRouting.class.php 18 2008-11-17 08:37:52Z aranova $
 */
class arPropelAddressableRouting
{
  ...
  static public function listenToRoutingLoadConfigurationEvent(sfEvent $event)
  {
    ...
    $r->connect('address_history_by_id', new sfRoute('/address/history/:id', array('module' => 'address', 'action' => 'history')));
    ...
    $r->connect('address_list_by_tag', new sfRoute('/address/list/:tag', array('module' => 'address', 'action' => 'listByTag')));
    $r->connect('address_create', new sfRoute('/address/create', array('module' => 'address', 'action' => 'create')));
    $r->connect('address_delete_related', new sfRoute('/address/delete/:id/:related/:oid', array('module' => 'address', 'action' => 'deleteObject')));
