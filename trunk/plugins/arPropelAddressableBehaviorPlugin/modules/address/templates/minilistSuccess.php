          ...
          <tr id="address_<?php echo $address->getId() ?>" class="row_<?php echo $odd ?>">
                <td class="actions">
                    <div class="objectActions">
                        <ul>
                          <li><?php echo link_to(image_tag(sfConfig::get("yui_icons_web_dir") . "/application_form.png", 'alt="View"'), '@address_show_by_id?id='.$address->getId()) ?></li>
                            <li><?php echo link_to(image_tag(sfConfig::get("yui_icons_web_dir") . "/application_form_edit.png", 'alt="Edit"'), '@address_edit_by_id?id='.$address->getId()) ?></li>
