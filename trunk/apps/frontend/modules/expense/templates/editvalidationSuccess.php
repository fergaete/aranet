...
<div class="popUpWindow" id="ABBAexpWindow<?php echo $expense_item->getId() ?>" style="text-align: left; width: 190px;">
    <div style="text-align: right;">
        <?php echo link_to_function(image_tag('buttonCloseSmall.gif', 'alt="Close"'),
            visual_effect('fade', 'expWindow' . $expense_item->getId())) ?>
    </div>
    <div style="height: 5px;"></div>
    <div id="windowContent" style="text-align: left;">
        <div style="text-align: left;" id="expenseWindowOpen<?php echo $expense_item->getId() ?>">
            <?php echo form_tag('expense/updatevalidation') ?>
            <?php echo input_hidden_tag('id', $expense_item->getId()) ?>
            ...
            <?php echo submit_to_remote('submit', '', array(
                    'update'   => 'expValidation' . $expense_item->getId(),
