...
class anActions extends sfActions
{
  ...
  */
  ...
  protected function processList($c, $peerMethod = 'doSelect') {
    ...
    $this->pager = call_user_func_array($model . 'Peer::getPager', array($this->getRequestParameter('page', 1)-1, $peerMethod, $n, $c));
  }
  ...
  protected function processSort ()
  {
    if ($this->getRequestParameter('sort'))
    {
      ...
      $this->getUser()->setAttribute('dir', $this->getRequestParameter('dir', $this->getOrderDir()), $this->getModuleName().'/sort');
    }
    ...
    if (!$this->getUser()->getAttribute('sort', null, $this->getModuleName().'/sort'))
    {
      ...
      $this->getUser()->setAttribute('dir', $this->getOrderDir(), $this->getModuleName().'/sort');
    }
  }
