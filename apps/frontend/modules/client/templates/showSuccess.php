...
<h3 id="pageSubTitle" style="padding-top: 10px;"><?php echo __('View client details') ?>: <span class="subText"><?php echo $client ?></span></h3>

<div id="clientDisplay" class="windowFrame">
    <table style="width: 100%">
    <tr>
        <td class="leftSide">
            <span class="bigText"><?php echo $client ?></span><br \>
            ...
            <div class="infoWindowMenu">
                <ul id="menuItems">
                    <li id="menuItemStats" class="menuItemSelected"><?php echo link_to_remote('<span>'.__('Client stats').'</span>', array(
                        'update' => 'infoWindow',
                        'url'    => 'client/stats?id='.$client->getId(),
...
<?php include_partial('stats', array('client' => $client)) ?>
            ...
            <div id="cliDetailActions" class="detailActions">
              <ul>
                <li><?php echo button_to(__('Edit'), '@client_edit_by_id?id=' . $client->getId()) ?></li>
                <li><?php echo button_to(__('List'), '@client_list') ?></li>
                <li><?php echo button_to(__('Delete'), '@client_delete_by_id?id=' . $client->getId(), 'post=true&confirm=' . __('Are you sure?')) ?></li>
              </ul>
            </div>
        </td>
    </tr>
