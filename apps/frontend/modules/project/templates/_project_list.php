...
<?php foreach ($projects as $project): ?>
            <tr id="project_<?php echo $project->getId() ?>">
                ...
                <ul>
                  <li><?php echo link_to(image_tag("/images/button_view.gif", 'alt="'.__('View').'"'), 'project/show?id='.$project->getId()) ?></li>
                  <li><?php echo link_to(image_tag("/images/button_edit.gif", 'alt="'.__('Edit').'"'), 'project/edit?id='.$project->getId()) ?></li>
