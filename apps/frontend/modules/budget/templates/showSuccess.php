...
<?php include_partial('stats', array('budget' => $budget)) ?>
            ...
            <div id="budgetEdit" stlye="display: none;"></div>
                <div id="budDetailActions" class="detailActions">
                    <ul>
                      <li><?php echo link_to(image_tag('buttonEditLarge.gif', 'alt="'.__('Edit budget details').'"'), '/budget/edit?id=' . $budget->getId()) ?></li>
                      <li><?php echo link_to(image_tag('buttonPrintLarge.gif', 'alt="'.__('Print budget').'"'), '/budget/print?id=' . $budget->getId()) ?></li>
                      <li><?php echo link_to(image_tag('buttonCopyLarge.gif', 'alt="'.__('Copy budget').'"'), '/budget/create?id=' . $budget->getId()) ?></li>
                      <li><?php echo link_to(image_tag('buttonCopyLarge.gif', 'alt="'.__('Create invoice').'"'), '/budget/createinvoice?id=' . $budget->getId()) ?></li>
                      <li><?php echo link_to(image_tag('buttonDeleteLarge.gif', 'alt="'.__('Delete budget').'"'), '/budget/delete?id=' . $budget->getId(), 'post=true&confirm=' . __('Are you sure?')) ?></li>
                    </ul>
                </div>
        </td>
    </tr>
