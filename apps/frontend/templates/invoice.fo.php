...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
  ...
  <fo:layout-master-set>
    ...
    <fo:simple-page-master master-name="first"
          ...
          margin-left="0cm"
          margin-right="0cm">
      <fo:region-body margin-top="4cm" margin-left="3cm" margin-right="2cm" margin-bottom="3cm"/>
    ...
    <fo:simple-page-master master-name="rest"
                  ...
                  margin-left="0cm"
                  margin-right="0cm">
      <fo:region-body margin-top="5cm" margin-left="3cm" margin-right="2cm" margin-bottom="3cm"/>
...
<fo:page-sequence-master master-name="basicPSM" >
  ...
  <fo:page-sequence master-reference="basicPSM" initial-page-number="1">
    ...
    <fo:static-content flow-name="xsl-region-before">
        <fo:block id="N2545">
            <fo:external-graphic src="<?php echo sfConfig::get('sf_web_dir') ?>/images/aranova/enc_documentos_A4.png"/>
        </fo:block>
<?php include_slot('title') ?>
    ...
    <fo:static-content flow-name="xsl-region-after">
        <fo:block-container position="absolute" top="0cm" left="20px">
            <fo:block id="N2547">
                <fo:external-graphic src="<?php echo sfConfig::get('sf_web_dir') ?>/images/aranova/watermark+foot_documentos_A4.png"/>
            </fo:block>
        </fo:block-container>
    ...
    <fo:static-content flow-name="xsl-region-start">
            <fo:block-container reference-orientation="90" position="absolute" left="0.7cm" top="8cm" width="15cm">
