...
<?php $i = 0; foreach ($pager->getResults() as $sf_guard_user_profile): $odd = fmod(++$i, 2); ?>
       ...
       <div class="objectActions">
          <ul>
            <li><?php echo link_to(image_tag("/images/button_view.gif", 'alt="View"'), 'user/show?id='.$sf_guard_user_profile->getId()) ?></li>
            <li><?php echo link_to(image_tag("/images/button_edit.gif", 'alt="Edit"'), 'user/edit?id='.$sf_guard_user_profile->getId()) ?></li>
