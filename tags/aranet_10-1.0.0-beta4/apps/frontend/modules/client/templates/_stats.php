                    ...
                    <table class="gridTable">
                        ...
                        <tr>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <th style="text-align: right; width:40%"><?php echo __('Active amount') ?></th>
                                    <td><?php //echo format_currency($client->getClientActiveBudgets(), 'EUR') ?></td>
                                </tr>
                                <tr>
                                    <th style="text-align: right; width:40%"><?php echo __('Approved amount') ?></th>
                                    <td><?php //echo format_currency($client->getClientApprovedBudgets(), 'EUR') ?></td>
                                </tr>
                                <tr>
                                    <th style="text-align: right; width:40%"><?php echo __('Total amount') ?></th>
