...
abstract class sfModelTest extends lime_test
{
  ...
  protected $number_of_tests = null; 

  public function __construct($fixturesFileOrDir = null, $test_count = null, $handler = null) 
  {
    ...
    if (!is_readable($this->testDataDir)) {
     ...
     if(!isset($test_count)) { 
       $test_count = $this->number_of_tests; 
     } 

     if(!isset($handler)) { 
       $handler =  new lime_output_color(); 
     } 

     parent::__construct($test_count, $handler); 
  }
